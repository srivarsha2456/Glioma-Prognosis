...
class DisplayAug:
    ...
    def displayAug(self):
        ...
        cv.imwrite('C://Users//asiva//OneDrive//Desktop\Enhancing Glioma Prognosis with Explainable AI: A Transparent Machine Learning Approach//static//img//augment.png',tumorImage)